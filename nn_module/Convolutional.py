...
net = nn.Net([nn.Convolutional(1, 2, (3,3), 1, nn.tanh_activation),
    nn.Dropout(0.4),
    nn.Convolutional(2, 1, (5,5), 1, nn.tanh_activation),
    nn.Pooling((2,2)),
    nn.FlattenDense(100, nn.tanh_activation),
    nn.Dropout(0.4),
    nn.Dense(100, 10, "glorot", tf.nn.softmax)],
